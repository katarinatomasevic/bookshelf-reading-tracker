...
namespace Bookshelf.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810203844_AddBookEmbeddingAndSeedColumns")]
    partial class AddBookEmbeddingAndSeedColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookshelf.Domain.Entities.ReadingLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserBookId", "Date")
                        .IsUnique()
                        .IsDescending(false, true);

                    b.ToTable("ReadingLog", null, t =>
                        {
                            t.HasCheckConstraint("CK_ReadingLog_PagesRead", "\"PagesRead\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Bookshelf.Domain.Entities.ReadingLog", b =>
                {
                    b.HasOne("Bookshelf.Domain.Entities.UserBook", null)
                        .WithMany()
